...
GitHub offers __Ubuntu Linux, Microsoft Windows__, and __macOS__ runners. This means you can test your scripts and documents on different systems, to ensure your processes are cross-platform compatible!
...
__Artifacts__ allows data to persist after a job has completed, and share that data with another job in the same workflow.

By default, GitHub stores build logs and artifacts for 90 days (customizable).

To share data between jobs, you must:

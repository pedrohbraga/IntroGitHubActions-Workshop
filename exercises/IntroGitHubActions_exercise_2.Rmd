---
title: "Exercise #2"
subtitle: "Introduction to GitHub and GitHub Actions!"
date: "`r Sys.time()`"
output:
  rmdformats::downcute:
    self_contained: true
...
You can find the repository and the document [here](https://github.com/pedrohbraga/IntroGitHubActions-Workshop).
...
penguins <- read.csv("data/palmerpenguins_updated_dataset.csv")
